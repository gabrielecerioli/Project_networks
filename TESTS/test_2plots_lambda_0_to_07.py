...
# ----------------------------------------------------------------------
# 1. File Paths and Lookups Setup
# ----------------------------------------------------------------------
...
# Countries to track country-by-country
tracked_countries = ["USA", "CHN", "DEU", "JPN", "GBR", "FRA", "ITA", "KOR", "IND", "MEX"]
country_trade_evolution = {iso: [] for iso in tracked_countries}
yearly_results = []

# ----------------------------------------------------------------------
# 2. Multi-Decade Country-by-Country Inference Loop
# ----------------------------------------------------------------------
print("\nRunning inference loop across 1965–2024...")
...
for yr in all_years:
    ...
    # Record individual country market shares
...
print("Inference completed across all years.")

# ----------------------------------------------------------------------
# 3. Clean 2-Panel Visualization (Top 2 Plots Only, y in [0.0, 0.7])
# ----------------------------------------------------------------------
...
# Panel 1: Clean Evolution of Global Lambda over Time (y-range: 0.0 to 0.7)
ax1 = axes[0]
...
ax1.set_title("Global Geopolitical Bloc Weight λ (1965–2024)", fontweight="bold", fontsize=11)
ax1.set_ylim(0.0, 0.7)
ax1.grid(True, ls="--", alpha=0.35)
ax1.legend(loc="upper right", fontsize=9, framealpha=0.9)

# Panel 2: Country-Level Market Share Evolution (Top 10 Powers)
ax2 = axes[1]
country_colors = {
...
ax2.set_title("Country-Level Trade Share Evolution (1965–2024)", fontweight="bold", fontsize=11)
ax2.grid(True, ls="--", alpha=0.35)
ax2.legend(loc="upper right", fontsize=8, ncol=2, framealpha=0.9)

plt.tight_layout()
plt.savefig("test_2plots_lambda_0_to_07.png", dpi=150)
print("\nPlot saved successfully to test_2plots_lambda_0_to_07.png")

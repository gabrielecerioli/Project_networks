...
# Test running cell 1 directly
print("Testing cell 1 execution...")

output_dir = "Robustness_tests" if not os.getcwd().endswith("Robustness_tests") else "."
...
# Small test with 3 networks
N_BENCHMARK_NETWORKS = 3
lrs = [1e-3, 1e-2, 1e-1]
T_ADAM = 20
T_LBFGS = 20

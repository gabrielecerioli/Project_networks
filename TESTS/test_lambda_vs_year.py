...
# Select years spanning historical to modern era
years_to_analyze = [1960, 1965, 1970, 1975, 1980, 1985, 1988, 1990, 1995, 2000, 2005, 2008, 2012, 2015, 2019, 2020]
N_NATIONS = 100
R_EARTH = 6371.0
SIGMA_GAUGE = 1.0
d_s = 2
...
print(f"Loading CEPII Gravity for {len(years_to_analyze)} years: {years_to_analyze}…")
t_start = time.time()
chunks = []
...
print(f"Loaded {len(df_raw)} total rows in {time.time() - t_start:.2f}s.")

# Combine tradeflow values
df_raw['val'] = df_raw['tradeflow_baci'].fillna(df_raw['tradeflow_comtrade_o']).fillna(df_raw['tradeflow_comtrade_d'])

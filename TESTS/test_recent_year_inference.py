...
# ======================================================================
# Test Inference on 2019 CEPII Gravity (BACI Harmonized Trade Flows)
# ======================================================================
...
# 2. Read 2019 Gravity Data with BACI tradeflow
...
# Use BACI harmonized trade flow, with COMTRADE as fallback
...
# Filter positive trade and no self-loops
df_trade = df_trade[
    (df_trade['val'] > 0) &
...
# ----------------------------------------------------------------------
# 3D Spherical Coordinates & Weighted Adjacency
# ----------------------------------------------------------------------
R_EARTH = 6371.0
...
# ----------------------------------------------------------------------
# Gauge-Invariant Profile Likelihood Inference
# ----------------------------------------------------------------------
t_inf = time.time()
...
plt.tight_layout()
plt.savefig("test_2019_figure.png", dpi=150)
print("\nPlot saved successfully to test_2019_figure.png")
